...
<head>
    ...
    <meta charset="utf-8" />
		...
		<link rel="stylesheet" href="/shop/Public/App/css/appslider.css" />
	    <!--组件依赖js begin-->
        ...
        <script type="text/javascript" src="/shop/Public/App/js/appslider.min.js"></script>
    	<!--追入购物车角标-->
		<style>
...
<script>
	var share_url = "http://<?php echo ($_SERVER['HTTP_HOST']); ?>/shop/App/Shop/goods/ppid/<?php echo ($_SESSION['WAP']['vipid']); ?>/id/<?php echo ($cache["id"]); ?>";

    ...
    <form action="" method="post" id="AppForm">
        ...
        <div class="add-ads back2">
            <ul class="add-uls">
                ...
                <li class="border-b1 ovflw"><span class="fl">电话</span>
                    <input type="text" name="txmobile" value="<?php echo ($vip["txmobile"]); ?>" placeholder="请输入联系电话" id="txmobile">
                </li>
                <li class="border-b1 ovflw yinhang" style="display: none;">
                    <span class="fl">开户银行</span>
                    <input type="text" name="txyh" value="<?php echo ($vip["txyh"]); ?>" placeholder="如“中国工商银行”" id="txyh" />
                </li>
                <li class="border-b1 ovflw yinhang" style="display: none;">
                    <span class="fl">所属分行</span>
                    <input type="text" name="txfh" value="<?php echo ($vip["txfh"]); ?>" placeholder="如“广州黄埔支行”" id="txfh" />
                </li>
                <li class="border-b1 ovflw yinhang" style="display: none;">
                    <span class="fl">开户行所在地</span>
                    <input type="text" name="txszd" value="<?php echo ($vip["txszd"]); ?>" placeholder="如“广东省，广州市”" id="txszd" />
                </li>
                <li class="border-b1 ovflw yinhang" style="display: none;">
                    <span class="fl">银行卡号</span>
                    <input type="text" name="txcard" value="<?php echo ($vip["txcard"]); ?>" placeholder="请输入银行卡号" id="txcard" />
                </li>
            </ul>
        </div>

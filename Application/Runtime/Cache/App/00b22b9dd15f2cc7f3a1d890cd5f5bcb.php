...
<body class="back1">
		...
		<?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="ads-lst border-b1 ovflw mr-b back2 color6">
				...
				<p class=" ads_ortt3 fonts85 ovflw"><span class="fr">
					...
					<?php if(($vo["status"]) == "3"): if(($shopset["isth"]) == "1"): ?><a href="<?php echo U('App/Shop/orderTuihuo',array('sid'=>0,'orderid'=>$vo['id']));?>" class="home-cz">我要退货</a><?php endif; ?><a href="<?php echo U('App/Shop/orderOK',array('sid'=>0,'orderid'=>$vo['id']));?>" class="home-rz">确认收货</a><?php endif; ?></span></p>
			</div><?php endforeach; endif; else: echo "" ;endif; ?>
		</div>

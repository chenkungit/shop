...
<head>
    ...
    <script type="text/javascript" src="/shop/Public/App/js/countUp.js"></script>
...
<body class="back1">
    <div class="home-hd" style="background: url(/shop/Public/App/img/head-bg.png) no-repeat;background-size: 100% 100%;">
        <div class="home-hdc ovflw">
            ...
            <div class="fr home-dj">
                <?php if(($isqiandao) == "1"): ?><a href="#" class="home-qd ovflw text-c color3" id="home-qd">
                        <div class="qd-img">
                            <img src="/shop/Public/App/img/qd.png" />
                        </div>

...
<head>
    ...
    <!--组件依赖js begin-->
    <script src="/shop/Public/App/js/zepto.min.js"></script>
    <script src="/shop/Public/App/js/fx.js"></script>
    <script src="/shop/Public/App/js/fx_methods.js"></script>
	
    <script type="text/javascript" src="/shop/Public/App/gmu/iscroll.js"></script>
    <script type="text/javascript" src="/shop/Public/App/gmu/gmu.min.js"></script>
    <script type="text/javascript" src="/shop/Public/App/gmu/widget.js"></script>
    <script type="text/javascript" src="/shop/Public/App/gmu/navigator.js"></script>
    <script type="text/javascript" src="/shop/Public/App/gmu/scrollable.js"></script>
    <!--组件依赖js end-->
    <!--轮播js begin-->
    <script src="/shop/Public/App/js/tool.js"></script>
    <script src="/shop/Public/App/js/swipe.js"></script>
...
<body class="index">
                        ...
                        <li <?php if(($type) == "0"): ?>class="ui-state-active"<?php endif; ?> id="ui-li">
                            <a href="<?php echo U('App/Shop/index#nav',array('type'=>0));?>">
                                <div <?php if(($type) == "0"): ?>class="ui-imgs indexiconson"
                                    <?php else: ?>class="ui-imgs indexiconsoff"<?php endif; ?> style="background-image: url('/shop/Public/App/img/index_all.png');" id="ui-imgs"></div>
    ...
    <!-- 导航栏滚动时锁定在屏幕上方-->
    <script type="text/javascript" src="/shop/Public/App/js/menuFixed.js"></script>
    <script type="text/javascript">

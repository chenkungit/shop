        ...
        <div class="widget radius-bordered">
            ...
            <div class="widget-body">
                <form id="AppForm" action="" method="post" class="form-horizontal" data-bv-message="" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">合伙人</label>
                        <div class="col-lg-4">
                            <label>
                                <input type="hidden" name="ishhr" value="<?php echo ($cache["ishhr"]); ?>" id="ishhr">
                                <input class="checkbox-slider slider-icon colored-darkorange" type="checkbox" id="ishhrbtn" <?php if(($cache["ishhr"]) == "1"): ?>checked="checked"<?php endif; ?>>
                                <span class="text darkorange">&nbsp;&nbsp;&larr;重要：启用后会员将变成合伙人,每月可享受分红。</span>
                            </label>
                        </div>
                        <!--<label class="col-lg-1 control-label">生效日期</label>
                        <div class="input-group col-lg-3">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            <input type="text" class="form-control" id="hhrtime" name="hhrtime" value="<?php echo ($cache["hhrtime"]); ?>"/>
                        </div>
                        -->
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">精英俱乐部</label>
                        <div class="col-lg-4">
                            <label>
                                <input type="hidden" name="isjyjlb" value="<?php echo ($cache["isjyjlb"]); ?>" id="isjyjlb">
                                <input class="checkbox-slider slider-icon colored-darkorange" type="checkbox" id="isjyjlbbtn" <?php if(($cache["isjyjlb"]) == "1"): ?>checked="checked"<?php endif; ?>>
                                <span class="text darkorange">&nbsp;&nbsp;&larr;重要：启用后会员将变成精英俱乐部,每月可享受分红。</span>
                            </label>
                        </div>
                        <!--
                        <label class="col-lg-1 control-label">生效日期</label>
                        <div class="input-group col-lg-3">
                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            <input type="text" class="form-control" id="jyjlbtime" name="jyjlbtime" value="<?php echo ($cache["jyjlbtime"]); ?>"/>
                        </div>
                        -->
                    </div>
                    <!-- <div class="form-group">

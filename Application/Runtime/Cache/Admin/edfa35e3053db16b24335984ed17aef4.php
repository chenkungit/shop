...
<head>
    ...
    <link rel="shortcut icon" href="/shop/Public/Admin/img/favicon.png" type="image/x-icon">
    <!--Basic Styles-->
    <link href="/shop/Public/Admin/css/bootstrap.min.css" rel="stylesheet" />
    <link href="/shop/Public/Admin/css/font-awesome.min.css" rel="stylesheet" />
    <link href="/shop/Public/Admin/css/weather-icons.min.css" rel="stylesheet" />
    <!--Beyond styles-->
    <link id="beyond-link" href="/shop/Public/Admin/css/beyond.min.css" rel="stylesheet" />
    <link href="/shop/Public/Admin/css/demo.min.css" rel="stylesheet" />
    <link href="/shop/Public/Admin/css/typicons.min.css" rel="stylesheet" />
    <link href="/shop/Public/Admin/css/animate.min.css" rel="stylesheet" />
    <link href="/shop/Public/Admin/css/appcms.css" rel="stylesheet" />
    <!--时间-->
    <link rel="stylesheet" href="/shop/Public/Admin/css/daterangepicker-bs3.css">
    <!--Skin Script: Place this script in head to load scripts for skins and rtl support-->
    <!--<script src="/shop/Public/Admin/js/skins.min.js"></script>-->
    <style>
    .upimgwell {
        margin-bottom: 0px;
    }
...
<body>
    ...
    <div class="loading-container" id="App-loading-wrap">
        <div id="loading" style="top: 150px; display: block;"><div class="lbk"></div><div class="lcont"><img src="/shop/Public/Admin/img/loading.gif" alt="loading...">正在加载...</div></div>
    </div>
    <!--  /Loading Container -->
    <!-- Navbar -->
    <div class="navbar">
                            ...
                            <ul class="submenu">
                                ...
                                <li>
                                    <a href="<?php echo U('Admin/Wxhongbao/wxtxorder');?>" data-loader="App-loader" data-loadername="微信红包提现订单管理-新订单">
                                        <i class="glyphicon glyphicon-usd"></i>
                                        <span class="menu-text">微信红包提现</span>
                                    </a>
                                </li>
                                <li>
    ...
    <!--基础脚本-->
    <script src="/shop/Public/Admin/js/jquery-2.0.3.min.js"></script>
    <script src="/shop/Public/Admin/js/bootstrap.min.js"></script>
    <script src="/shop/Public/Admin/js/beyond.min.js"></script>
    <script src="/shop/Public/Admin/js/toastr/toastr.js"></script>
    <script src="/shop/Public/Admin/js/validation/bootstrapValidator.js"></script>
    <script src="/shop/Public/Admin/js/bootbox/bootbox.js"></script>
    <!--时间-->
    <script src="/shop/Public/Admin/js/moment.min.js"></script>
    <script src="/shop/Public/Admin/js/daterangepicker.js"></script>
    <!--统计脚本-->
    <script src="/shop/Public/Admin/js/charts/easypiechart/jquery.easypiechart.js"></script>
    <script src="/shop/Public/Admin/js/charts/easypiechart/easypiechart-init.js"></script>
    <script src="/shop/Public/Admin/js/charts/flot/jquery.flot.js"></script>
    <script src="/shop/Public/Admin/js/charts/flot/jquery.flot.orderBars.js"></script>
    <script src="/shop/Public/Admin/js/charts/flot/jquery.flot.tooltip.js"></script>
    <script src="/shop/Public/Admin/js/charts/flot/jquery.flot.resize.js"></script>
    <script src="/shop/Public/Admin/js/charts/flot/jquery.flot.selection.js"></script>
    <script src="/shop/Public/Admin/js/charts/flot/jquery.flot.crosshair.js"></script>
    <script src="/shop/Public/Admin/js/charts/flot/jquery.flot.stack.js"></script>
    <script src="/shop/Public/Admin/js/charts/flot/jquery.flot.time.js"></script>
    <script src="/shop/Public/Admin/js/charts/flot/jquery.flot.pie.js"></script>
    <script src="/shop/Public/Admin/js/charts/chartjs/Chart.js"></script>
    <!--百度地图类库-->
    <script type="text/javascript" src="http://api.map.baidu.com/api?v=2.0&ak=StGl5qQsPbsCVg8tizbLbkOw"></script>
    <!--App全局API-->
    <script src="/shop/Public/Admin/js/appapi.js"></script>

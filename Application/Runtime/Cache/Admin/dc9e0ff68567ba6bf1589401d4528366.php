<?php if (!defined('THINK_PATH')) exit();?><style>
	...
	#App-uploader-body .cover{ width: 130px; height: 100px; position: absolute; left: 0px; top:0px; background:url('/shop/Public/Admin/img/choosed.png'); display: none;}
...
<div id="App-uploader">
	<div id="App-uploader-header">
		<div class="hide">
			...
			<form enctype="multipart/form-data" action="<?php echo U('Admin/Upload/doupimg');?>" method="post" id="App-uploader-form" target="App-uploader-frame" >
	...
	<div id="App-uploader-body" data-page = "2">
		<?php if(is_array($cache)): $i = 0; $__LIST__ = $cache;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="imgwp" data-id = "<?php echo ($vo["id"]); ?>" data-check = "0" onclick="checkupload(this);">
				<img src="/shop/Upload/<?php echo ($vo["savepath"]); echo ($vo["savename"]); ?>" />
				<div class="cover"></div>
...
<script>
	...
	$(Jupgetmore).on('click',function(){
		...
		var moreurl="<?php echo U('Admin/Upload/getmoreimg/');?>";
		var more;
		$.ajax({
			type:"post",			
			data:{'p':p},
	...
	$(Jupdelall).on('click',function(){
		...
		var delimgurl="<?php echo U('Admin/Upload/delimgs');?>";

...
<script src="/shop/Public/Admin/ueditor/ueditor.config.js"></script>
<script src="/shop/Public/Admin/ueditor/ueditor.all.min.js"></script>
<div class="row">
                ...
                <form id="AppForm" action="" method="post" class="form-horizontal" data-bv-message="" data-bv-feedbackicons-valid="glyphicon glyphicon-ok" data-bv-feedbackicons-invalid="glyphicon glyphicon-remove" data-bv-feedbackicons-validating="glyphicon glyphicon-refresh">
                   ...
                   <div class="form-group">
                    ...
                    <div class="form-group" id="backratio">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="backratio" placeholder="例如0.01" value="<?php echo ($cache["backratio"]); ?>">
                        </div>
                    </div>  
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="sorts" placeholder="必填" data-bv-notempty="true" data-bv-notempty-message="不能为空" value="<?php echo ($cache["sorts"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label class="col-lg-2 control-label">金果兑换</label>
                        <div class="col-lg-4">
                            <label>
                                <input type="hidden" name="isapple" value="<?php echo ($cache["isapple"]); ?>" id="isapple">
                                <input class="checkbox-slider slider-icon colored-darkorange" type="checkbox" id="isapplebtn" <?php if(($cache["isapple"]) == "1"): ?>checked="checked"<?php endif; ?>>
                                <span class="text darkorange"></span>
                            </label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">赠送购物券金额</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="gwqmoney" id="gwqmoney"  value="<?php echo ($cache["gwqmoney"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 control-label">购物券每日封顶金额</label>
                        <div class="col-lg-4">
                            <input type="text" class="form-control" name="maxgwqmoney" id="maxgwqmoney"   value="<?php echo ($cache["maxgwqmoney"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
...
$('#isbdbtn').on('click', function() {
    ...
    if(!value)
    {
        $('#gwqmoney').attr("disabled",true);
        $('#gwqmoney').val('0');
        $('#maxgwqmoney').attr("disabled",true);
        $('#maxgwqmoney').val('0');
    }else
    {
        $('#gwqmoney').removeAttr("disabled");
        $('#maxgwqmoney').removeAttr("disabled");
    }
});
$('#isapplebtn').on('click', function() {
    var value = $(this).prop('checked') ? 1 : 0;
    $('#isapple').val(value);
    if(!value)
    {
        $('#appleqty').attr("disabled",true);
        $('#appleprice').attr("disabled",true);
    }else
    {
        $('#appleqty').removeAttr("disabled");
        $('#appleprice').removeAttr("disabled");
    }
});

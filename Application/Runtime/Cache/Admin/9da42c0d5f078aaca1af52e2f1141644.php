...
<div id="bodybox">
    ...
    <img src="/shop/Public/Admin/img/help/image1.png" />
    ...
    <img src="/shop/Public/Admin/img/help/image2.png" />
    ...
    <img src="/shop/Public/Admin/img/help/image3.png" />
    <p class="text-center">图3 系统后台对应位置</p>
    <img src="/shop/Public/Admin/img/help/image4.png" />
    ...
    <p>建议设置项：</p>
    <p>商城首页：http://<?php echo $_SERVER['HTTP_HOST'];?>/shop/App/Shop/index</p>
    <p>个人中心：http://<?php echo $_SERVER['HTTP_HOST'];?>/shop/App/Vip/index</p>
	<p>我的专属：http://<?php echo $_SERVER['HTTP_HOST'];?>/shop/App/Fx/myqrcode</p>
    <p>订单中心：http://<?php echo $_SERVER['HTTP_HOST'];?>/shop/App/Shop/orderList/sid/0/</p>
    <p>关于我们：http://<?php echo $_SERVER['HTTP_HOST'];?>/shop/App/Vip/about</p>
    <p>卡券中心：http://<?php echo $_SERVER['HTTP_HOST'];?>/shop/App/Vip/card</p>
    <p>申请提现：http://<?php echo $_SERVER['HTTP_HOST'];?>/shop/App/Vip/txOrder</p>
    <p>提现资料：http://<?php echo $_SERVER['HTTP_HOST'];?>/shop/App/Vip/tx</p>
    <p>资料绑定：http://<?php echo $_SERVER['HTTP_HOST'];?>/shop/App/Vip/info</p>
    <p>地址管理：http://<?php echo $_SERVER['HTTP_HOST'];?>/shop/App/Vip/address</p>
    <p>个人消息：http://<?php echo $_SERVER['HTTP_HOST'];?>/shop/App/Vip/message</p>
    <p>手机端帮助中心：http://<?php echo $_SERVER['HTTP_HOST'];?>/shop/Home/index/help</p>
    ...
    <img src="/shop/Public/Admin/img/help/image5.png" />
